...
use crate::contract_vm::rpc_mock::querier::RpcMockQuerier;
...
pub fn new_mock(
    ...
    contract_addr: &str,
) -> Backend<RpcMockApi, RpcMockStorage, RpcMockQuerier> {
    Backend {
        storage: RpcMockStorage::default(),
        api: RpcMockApi::new(canonical_length),
        querier: RpcMockQuerier::new(&[(contract_addr, contract_balance)]),
    }
}
